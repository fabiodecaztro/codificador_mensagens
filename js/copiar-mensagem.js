const botaoCopiar = document.querySelector('[data-botao-copiar]');
let caixaDecodificador = document.querySelector('[data-caixa-decodificador]');
let mensagens = document.querySelector('[data-mensagens]')
